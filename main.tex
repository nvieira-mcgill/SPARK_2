...
\begin{itemize}
    ...
    \item Corner plots used to obtain best fit, for 2.4 and 3.4 days---in an appendix
    
    \item Abundance patterns for best fit at 2.4 and 3.4 days; compared to 1.4 days
...
\begin{figure*}[!ht]
    ...
    \includegraphics[width=0.47\textwidth]{figs/leave_out_single_3.4d.png}
...
\begin{itemize}
    ...
    \item Corner plots used to obtain best fit, for 1.4, 2.4, and 3.4 days multi-component---in an appendix
    
    \item Wedge plots for 1.4, 2.4, and 3.4 days
    
    \item Leave-one-out spectra for best multi-component fit at 1.4, 2.4, and 3.4 days---in an appendix
...
\begin{figure*}[!ht]
    ...
    \figcaption{2.4 day fit corner plot}\label{fig:corner_single_2.4}
\end{figure*}
...
\begin{figure*}[!ht]
    ...
    \figcaption{3.4 day fit corner plot}\label{fig:corner_single_3.4}
\end{figure*}
...
\begin{figure*}[!ht]
    ...
    \figcaption{\textbf{Same as Figure~\ref{fig:corner_multi_1.4d}, for the 2.4 day, multi-component fit.}}\label{fig:corner_multi_2.4}
\end{figure*}

\begin{figure*}[!ht]
    \includegraphics[width=0.95\textwidth]{figs/appendix/corner_multi_3.4d.png}
    \figcaption{\textbf{Same as Figure~\ref{fig:corner_multi_1.4d}, for the 3.4 day, multi-component fit.}}\label{fig:corner_multi_3.4}
\end{figure*}
...
%%% === APPENDIX E === %%%
%% CONVERGENCE OF FITS %%
\section{Convergence of fits}\label{app:leave_out_multi}

In this section, we show the convergence of all fits. This includes single-component fits at 2.4 and 3.4 days, and multi-component fits at 1.4, 2.4, and 3.4 days.


%% double-column, each row showing convergence z and GP hyperparameters
\begin{figure*}[!ht]
    \includegraphics[width=0.47\textwidth]{figs/appendix/221022_084052_dynesty-sampling_convergence_z_eps0.5.png}
    \includegraphics[width=0.47\textwidth]{figs/appendix/2.4d_single_GPhparams.png}
    \includegraphics[width=0.47\textwidth]{figs/appendix/230322_013538_dynesty-sampling_convergence_z_eps0.5.png}
    \includegraphics[width=0.47\textwidth]{figs/appendix/3.4d_single_GPhparams.png}
    \includegraphics[width=0.47\textwidth]{figs/appendix/230103_064024_dynesty-sampling_convergence_z_eps0.5.png}
    \includegraphics[width=0.47\textwidth]{figs/appendix/1.4d_multi_GPhparams.png}
    \includegraphics[width=0.47\textwidth]{figs/appendix/230103_060017_dynesty-sampling_convergence_z_eps0.5.png}
    \includegraphics[width=0.47\textwidth]{figs/appendix/2.4d_multi_GPhparams.png}
    \includegraphics[width=0.47\textwidth]{figs/appendix/3.4d_multi_convergence_z.png}
    \includegraphics[width=0.47\textwidth]{figs/appendix/3.4d_multi_GPhparams.png}
    \figcaption{Leave-one-out spectra for the 1.4, 2.4, and 3.4 day multi-component fits}\label{fig:convergence}
\end{figure*}
