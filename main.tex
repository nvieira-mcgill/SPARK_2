...
\begin{figure*}[!ht]
    ...
    \figcaption{2.4 day, multi-component fit corner plot}\label{fig:corner_multi_2.4}
\end{figure*}

\begin{figure*}[!ht]
    \includegraphics[width=0.95\textwidth]{figs/corner_multi_3.4d.png}
    \figcaption{3.4 day, multi-component fit corner plot}\label{fig:corner_multi_3.4}
\end{figure*}
