...
%% corner plots
\begin{figure*}[!ht]
    \includegraphics[width=0.95\textwidth]{figs/221022_084052_dynesty_corner_pretty_smooth2d0.05_nodatapts_zoom.png}
    \figcaption{2.4 day fit corner plot}\label{fig:corner_single_2.4}
\end{figure*}

\begin{figure*}[!ht]
    \includegraphics[width=0.95\textwidth]{figs/230322_013538_dynesty_corner_pretty_mactive-600_smooth2d0.05_nodatapts.png}
...
\begin{figure*}[!ht]
    ...
    \includegraphics[width=0.98\textwidth]{figs/3.4d_abundances.png}
    \figcaption{2.4 and 3.4 day fit abundances}\label{fig:infer_abunds_single}
\end{figure*}
...
\begin{figure*}[!ht]
    ...
    \figcaption{2.4 day leave-one-out spectra}\label{fig:leave_out_single_2.4d}
\end{figure*}

\begin{figure*}[!ht]
    \includegraphics[width=0.985\textwidth]{figs/leave_out_single_3.4d.png}
    \figcaption{3.4 day leave-one-out spectra}\label{fig:leave_out_single_3.4d}
\end{figure*}
...
\begin{figure*}[!ht]
    \includegraphics[width=0.95\textwidth]{figs/230103_064024_dynesty_corner_pretty_mactive-1471_smooth2d0.05_nodatapts_ymax.png}
    \figcaption{1.4 day, multi-component fit corner plot}\label{fig:corner_multi_1.4}
\end{figure*}

\begin{figure*}[!ht]
    \includegraphics[width=0.95\textwidth]{figs/230103_060017_dynesty_corner_pretty_mactive-1020_smooth2d0.05_nodatapts.png}
    \figcaption{\textbf{Same as Figure~\ref{fig:corner_multi_1.4d}, for the 2.4 day, multi-component fit.}}\label{fig:corner_multi_2.4}
\end{figure*}

\begin{figure*}[!ht]
    \includegraphics[width=0.95\textwidth]{figs/corner_multi_3.4d.png}
